[![](https://github.com/wutsi/wutsi-rtm-server/actions/workflows/master.yml/badge.svg)](https://github.com/wutsi/wutsi-rtm-server/actions/workflows/master.yml)
...
- Install
```
$ git clone git@github.com:wutsi/wutsi-rtm-server.git
```
...
# Links
- [API](https://wutsi.github.io/wutsi-rtm-server/api/)
- [Documentation](docs/)
